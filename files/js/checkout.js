...
(function () {
  ...
  function ensureModal() {
    ...
    phoneWrap.appendChild(el("label", { className: "sms-label", for: "ack_sms_phone" }, ["Mobile phone number"]));
  ...
  function storedPhone() {
    var field = document.getElementById("ack_sms_phone");
    if (field && field.value.trim()) return field.value.trim();
    var home = document.getElementById("home-sms-phone") || document.getElementById("sms-phone");
    if (home && home.value.trim()) return home.value.trim();
    try {
